...
import org.scahyana.opmid.components.mica.SubtractionSameDenomClickableMica
...
@Composable
fun SubtractionSameDenomScreen(
    numeratorA: Int,
    numeratorB: Int,
    denominator: Int,
    ...
    fun addNumerator(remove: Boolean = false) {
        ...
        if (_actualClickedNumerator == numeratorA + numeratorB) {
    ...
    when {
        isDenominatorFinished.value -> {
            if (isDenominatorFinished.value) {
                LaunchedEffect(Unit) {
                    delay(500)
                    navController.navigate("finishscreen/${numeratorA}/${denominator}/${numeratorB}/${denominator}/$clickedNumerator/$clickedDenominator/1") {
            ...
            BoxWithConstraints {
                ...
                Box(
                    ...
                    // Top box after combined
                        ...
                        SubtractionSameDenomClickableMica(
