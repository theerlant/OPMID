...
import org.scahyana.opmid.components.mica.AdditionClickableMica
import org.scahyana.opmid.components.mica.AdditionSameDenomClickableMica
...
fun AdditionSameDenomScreen(
    ...
    fun addNumerator() {
        ...
        clickedNumerator++
        if (clickedNumerator == numeratorA  + numeratorB) {
    ...
    fun addDenominator() {
        ...
        clickedDenominator++
        if (clickedDenominator == denominator) {
    ...
    when {
        isDenominatorFinished.value -> {
            if (isDenominatorFinished.value) {
                LaunchedEffect(Unit) {
                    delay(500)
                    navController.navigate("finishscreen/${numeratorA}/${denominator}/${numeratorB}/${denominator}/$clickedNumerator/$clickedDenominator/0") {
            ...
            BoxWithConstraints {
                ...
                Box(
                    ...
                    // Top box after combined
                        ...
                        AdditionSameDenomClickableMica(
                            ...
                            numColor = Color.Green.copy(alpha = 0.33f),
